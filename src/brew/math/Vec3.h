...
public:
    ...
    static const Vec3 ONE; //< The neutral vector (1,1,1).
    static const Vec3 INF; //< The vector representing infinity.
    static const Vec3 UNIT_X; //< The x unit vector (1,0,0).
    static const Vec3 UNIT_Y; //< The y unit vector (0,1,0).
    static const Vec3 UNIT_Z; //< The z unit vector (0,0,1).
    static const Vec3 NEGATIVE_UNIT_X; // The negative x unit vector (-1,0,0).
    static const Vec3 NEGATIVE_UNIT_Y; // The negative y unit vector (0,-1,0).
    static const Vec3 NEGATIVE_UNIT_Z; // The negative z unit vector (0,0,-1).
};
